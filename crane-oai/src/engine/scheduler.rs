...
impl Scheduler {
    ...
    /// to build up the batch size for efficient decoding. Larger batches = better
    /// GPU utilization, and prefills are typically fast enough that the latency
    /// cost of back-to-back prefills is negligible.
